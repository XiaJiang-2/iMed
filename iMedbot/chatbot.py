...
training_data_quesans = open('iMedbot/training_data/ques_ans.txt').read().splitlines()
training_data_personal = open('iMedbot/training_data/personal_ques.txt').read().splitlines()
